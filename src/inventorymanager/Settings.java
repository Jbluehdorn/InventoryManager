...
public class Settings {
    public static final int windowHeight = 400, windowWidth = 500, skinnyWindowWidth = 375;
    ...
    public static int headerTextSize = 24;
    public static int subheaderTextSize = 20;
    public static int bodyTextSize = 13;
}
